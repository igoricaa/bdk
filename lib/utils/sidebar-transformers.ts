import { SidebarSection, SidebarItem, CategoriesTransformResult } from '@/types/sidebar';
import { CategoryWithChildren } from '@/lib/utils';
import ServicesIcon from '@/components/ui/icons/services-icon';
import IndustriesIcon from '@/components/ui/icons/industries-icon';
import ForeignDesksIcon from '@/components/ui/icons/foreign-desks-icon';
