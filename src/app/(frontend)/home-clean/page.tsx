...
import Hero from '@/src/components/home/hero-clean';
...
export default async function Home() {
  ...
  return (
    <main id='home'>
      ...
      <section
        id='about'
        className='px-side pt-12 md:pt-24 xl:py-30 2xl:py-43 bg-dark-blue rounded-t-main -mt-10 overflow-hidden relative z-10'
      >
