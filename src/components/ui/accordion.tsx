...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className='data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down animation-duration-500 xl:animation-duration-300 overflow-hidden text-sm'
      {...props}
    >
